...
async def scan_embed(member: discord.Member, resultfound: bool, foundon, joinedat, usernames=None, nicks=None) -> discord.Embed:
    ...
    embednok = discord.Embed(
        ...
        color=discord.Color.random())
    embednok.set_author(name=member.display_name,
                        url=member.display_avatar.url, icon_url=member.display_avatar.url)
    embednok.set_thumbnail(
        url="https://cdn.discordapp.com/avatars/839574978088796210/296b1a22e987d97431902d0e1db2bae2.png")
